...
- [ ] [simple] KH-DASHBOARD-ROUTE: Expose knowledge-hub dashboard externally. Currently 8093 is bound to 127.0.0.1 only. Need nginx route or docker-proxy entry to make dashboard accessible from LAN (like 8090 PMO dashboard).
