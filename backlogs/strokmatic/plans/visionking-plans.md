...
**Current State**:
- `services/length-measure/src/config.py` line 13: `DB_PASSWORD = os.getenv("DB_PASSWORD", "<skm-password>")`
- `services/inference/src/utils/read_env_var.py` line 13: `RABBIT_PASSWORD: str = os.getenv('RABBIT_PASSWORD', '<sissurface-password>')`
- `services/inference/src/utils/read_env_var.py` line 69: `REDIS_PASSWORD: str = os.getenv('REDIS_PASSWORD', '<sissurface-password>')`
...
- **Known issues**:
  - Hardcoded credential in `config.py` line 13 (`DB_PASSWORD = "<skm-password>"`)
