...
| Meeting Assistant | **Done** | [meeting-assistant.md](meeting-assistant.md) |
...
| Meeting Assistant | **Done** | v0.3.0 | 2026-02-23 | [spec](meeting-assistant.md) | MCP server with 9 tools: start/stop meeting, inject transcript, live notes,<br>minutes generation, action item extraction, backlog integration.<br>PipeWire + Deepgram STT pipeline with graceful fallback to manual mode. 65 tests. |
