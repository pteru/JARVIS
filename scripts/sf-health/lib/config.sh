#!/bin/bash
# SF Health Monitor — Configuration loader
...
CONFIG_FILE="$ORCHESTRATOR_HOME/config/sf-deployments/${DEPLOYMENT_ID}.json"
DATA_DIR="$ORCHESTRATOR_HOME/data/sf-health/${DEPLOYMENT_ID}"
REPORT_DIR="$ORCHESTRATOR_HOME/reports/sf-health/${DEPLOYMENT_ID}"
...
# ---------------------------------------------------------------------------
# Export threshold values (no GPU thresholds — SF has no GPU)
# ---------------------------------------------------------------------------
