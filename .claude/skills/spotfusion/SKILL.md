...
1. `/home/teruel/claude-orchestrator/workspaces/strokmatic/spotfusion/.claude/context.md` — Fan-out architecture, tech stack, repo structure
2. `/home/teruel/claude-orchestrator/workspaces/strokmatic/spotfusion/.claude/CLAUDE.md` — Project conventions, key patterns

Also explore the architecture directory for any diagrams or documentation:
- `/home/teruel/claude-orchestrator/workspaces/strokmatic/spotfusion/architecture/`
