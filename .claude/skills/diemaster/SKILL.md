...
1. `/home/teruel/JARVIS/workspaces/strokmatic/diemaster/.claude/context.md` — IoT architecture, firmware stack, known issues
2. `/home/teruel/JARVIS/workspaces/strokmatic/diemaster/.claude/CLAUDE.md` — Project conventions, security warnings
3. `/home/teruel/JARVIS/workspaces/strokmatic/diemaster/.claude/backlog.md` — Current task backlog with priorities
