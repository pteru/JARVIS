...
### Critical
1. **Hardcoded credentials in source code** (`hub_config.h:44`): Redis password `"<smartdie-password>"` is hardcoded. This is flagged in the project's CLAUDE.md as a KNOWN ISSUE requiring HIGH priority remediation. Same credential appears in `app_mqtt_task.h:184`.
