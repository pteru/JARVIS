...
title: Plan: PR Review Service v2 — Smart Re-Review, Auto-Post, Labels, Dashboard, Build Checks
description: The PR review service is deployed and running on 192.168.15.2 (`/opt/jarvis-pr-review/`), polling every 5 minutes via cron. It fetches open PRs, reviews them with Claude, uploads to Google Drive, a...
